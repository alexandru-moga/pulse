...
<div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Add New Block</h2>
                <p class="text-gray-600 dark:text-gray-300 mt-1">Add a new content block to "<?= htmlspecialchars($page['name']) ?>"</p>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white">Block Details</h3>
        </div>
        
        <form method="post" class="p-6">
            <div class="grid grid-cols-1 gap-6">
                <div>
                    <label for="block_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Block Name</label>
                    <input type="text" 
                           id="block_name" 
                           name="block_name" 
                           required 
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Can be JSON data or plain text, depending on block type.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" 
                               ...
                               min="0"
                               class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-gray-700 dark:text-white">
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Lower numbers appear first on the page.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <label class="inline-flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-900 dark:text-white">Active (visible on page)</span>
                            </label>
                        </div>
                    </div>
                </div>
