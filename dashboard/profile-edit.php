...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <form method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="school" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">School / University</label>
                    <input type="text"
                        id="school"
                        name="school"
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Search for any school, college, or university worldwide, or enter your own</p>
                </div>
            </div>
    </div>
    <div>
