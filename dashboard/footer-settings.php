...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold text-gray-900">Footer Settings</h2>
                <p class="text-gray-600 mt-1">Manage footer blocks and content</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <?php if (empty($blocks)): ?>
            <div class="p-6 text-center">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900">No footer blocks</h3>
