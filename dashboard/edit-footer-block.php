...
<div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Edit Footer Block</h2>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white">Footer Block Details</h3>
        </div>
        
        <form method="post" class="p-6">
            <div class="grid grid-cols-1 gap-6">
                <div>
                    <label for="section_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Section Type</label>
                    <input type="text" 
                           id="section_type" 
                           name="section_type" 
                           required 
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Examples: logo, links, cta, credits, social, contact</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Can be JSON data or plain text, depending on section type.</p>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="order_num" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Order Number</label>
                        <input type="number" 
                               id="order_num" 
                               name="order_num" 
                               required 
                               ...
                               min="0"
                               class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-gray-700 dark:text-white">
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Lower numbers appear first in the footer.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <label class="inline-flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-900 dark:text-gray-300">Active (visible in footer)</span>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                <button type="button" 
                        ...
                        class="px-4 py-2 border border-red-300 dark:border-red-600 rounded-md shadow-sm text-sm font-medium text-red-700 dark:text-red-400 bg-white dark:bg-gray-700 hover:bg-red-50 dark:hover:bg-red-900/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                    Delete Block
                </button>
