...
<div class="space-y-6">
    <?php if ($currentUser->active_member == 0): ?>
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-1 text-sm text-yellow-700 dark:text-yellow-300">
                        <p>Your account is currently inactive. You have limited access to view your own certificates, projects, and events. Please contact an administrator to reactivate your account for full access.</p>
                    </div>
                </div>
            </div>
        </div>
