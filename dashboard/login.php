...
require_once '../core/classes/GitHubOAuth.php';
require_once '../core/classes/GoogleOAuth.php';
require_once '../core/classes/SlackOAuth.php';
...
<body class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <?php if ($discordConfigured || $githubConfigured || $googleConfigured || $slackConfigured): ?>
                <div class="space-y-3 mb-6">
                    ...
                    <?php if ($githubConfigured): ?>
                        <a href="<?= htmlspecialchars($github->generateAuthUrl(true)) ?>" 
                    ...
                    <?php if ($googleConfigured): ?>
                        <a href="<?= htmlspecialchars($google->generateAuthUrl(true)) ?>" 
                    ...
                    <?php if ($slackConfigured): ?>
                        <a href="<?= htmlspecialchars($slack->generateAuthUrl(true)) ?>" 
            ...
            <form class="space-y-6 <?= ($discordConfigured || $githubConfigured || $googleConfigured || $slackConfigured) ? 'mt-6' : '' ?>" method="POST" action="login.php">
                <div>
