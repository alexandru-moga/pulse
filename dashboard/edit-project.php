    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-300 mt-1">Update project details and settings</p>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <form method="post" class="p-6">
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="reward_amount" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Monetary Reward ($)</label>
                        <input type="number" 
                               id="reward_amount" 
                               name="reward_amount" 
                               step="0.01" 
                    ...
                    <div>
                        <label for="reward_description" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Other Rewards</label>
