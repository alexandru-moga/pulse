...
<div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Add New Footer Block</h2>
                <p class="text-gray-600 dark:text-gray-300 mt-1">Add a new section to the website footer</p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <label class="inline-flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-900 dark:text-white">Active (visible in footer)</span>
                            </label>
                        </div>
                    </div>
                </div>
