    ...
    <div class="container mx-auto px-4">
        ...
        ?>
                    <div class="col-span-full mb-8">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">Leadership</h3>
                        <div class="members-grid grid grid-cols-1 md:grid-cols-<?= min(count($leaders), 3) ?> gap-8 justify-items-center">
        ...
        ?>
                    <div class="col-span-full mb-8">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">Co-Leaders</h3>
        ...
        ?>
                    <div class="col-span-full">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">Members</h3>
                        <div class="members-grid grid grid-cols-1 md:grid-cols-<?= $membersPerRow ?> gap-8">
