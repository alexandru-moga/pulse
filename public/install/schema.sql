...
INSERT INTO `menus` (`id`, `page_id`, `parent_id`, `title`, `order_num`, `visibility`, `roles`) VALUES
(1, 1, NULL, 'Home', 1, NULL, NULL),
(2, 2, NULL, 'Members', 2, NULL, NULL),
(3, 3, NULL, 'Apply', 3, NULL, NULL),
(4, 4, NULL, 'Contact', 4, NULL, NULL),
(5, 5, NULL, 'Dashboard', 5, NULL, NULL),
(10, 12, 5, 'Login', 10, 'guest', NULL),
(11, 13, 5, 'Forgot Password', 11, 'guest', NULL),
(20, 14, 5, 'Profile', 20, 'Member, Co-leader, Leader', NULL),
(21, 15, 5, 'Change Password', 21, 'Member, Co-leader, Leader', NULL),
(22, 16, 5, 'My Projects', 22, 'Member, Co-leader, Leader', NULL),
(23, 17, 5, 'User Management', 23, 'Co-leader, Leader', ''),
(24, 19, 5, 'Applications', 24, 'Co-leader, Leader', NULL),
(25, 20, 5, 'Contact Messages', 25, 'Co-leader, Leader', NULL),
(30, 18, 5, 'Logout', 30, 'Member, Co-leader, Leader', NULL);
...
INSERT INTO `pages` (`id`, `name`, `title`, `description`, `table_name`, `module_config`, `menu_enabled`, `created_at`) VALUES
(1, 'index', 'Home', 'Welcome to PULSE - Programming University Learning & Software Engineering', 'page_index', NULL, 1, '2025-05-10 17:47:05'),
(2, 'members', 'Members', 'Our PULSE community members', 'page_members', NULL, 1, '2025-05-10 17:47:05'),
(3, 'apply', 'Apply', 'Apply for a PULSE project', 'page_apply', NULL, 1, '2025-05-10 17:47:05'),
(4, 'contact', 'Contact', 'Get in touch with PULSE', 'page_contact', NULL, 1, '2025-05-10 17:47:05'),
(5, 'dashboard', 'Dashboard', 'Member dashboard', 'page_dashboard', NULL, 1, '2025-05-10 17:47:05'),
(6, 'applied', 'Applied', 'Applied Succesfully', 'page_applied', NULL, 0, '2025-05-15 06:10:22'),
(12, 'dashboard/login', 'Login', 'User login page', NULL, NULL, 0, '2025-05-28 09:21:51'),
(13, 'dashboard/forgot', 'Forgot Password', 'Reset your password', NULL, NULL, 0, '2025-05-28 09:21:51'),
(14, 'dashboard/index', 'Profile', 'User profile page', NULL, NULL, 0, '2025-05-28 09:27:57'),
(15, 'dashboard/change-password', 'Change Password', 'Change your password', NULL, NULL, 0, '2025-05-28 09:27:57'),
(16, 'dashboard/projects', 'My Projects', 'Your assigned projects', NULL, NULL, 0, '2025-05-28 09:27:57'),
(17, 'dashboard/users', 'User Management', 'Manage users', NULL, NULL, 0, '2025-05-28 09:27:57'),
(18, 'dashboard/logout', 'Logout', 'Logout', NULL, NULL, 0, '2025-05-31 18:40:41'),
(19, 'dashboard/applications', 'Applications', 'Applications', NULL, NULL, 0, '2025-06-08 05:17:14'),
(20, 'dashboard/contact_messages', 'Contact Messages', 'Contact Messages', NULL, NULL, 0, '2025-06-09 20:32:26');

CREATE TABLE `page_applied` (
  `id` int(11) NOT NULL,
...
(11, 'apply_title', 'title-3', '{\"text\": \"Join Example Club\"}', 1, 1),
...
INSERT INTO `page_dashboard` (`id`, `block_name`, `block_type`, `content`, `order_num`, `is_active`) VALUES
(6, 'dashboard_profile', 'dashboard-profile', '{}', 2, 1);
...
ALTER TABLE `menus`
  ADD CONSTRAINT `menus_ibfk_1` FOREIGN KEY (`page_id`) REFERENCES `pages` (`id`),
  ADD CONSTRAINT `menus_ibfk_2` FOREIGN KEY (`parent_id`) REFERENCES `menus` (`id`);
